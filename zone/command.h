...
void command_iplookup(Client* pClient, const Seperator* pSeperator);
...
void command_serverrules(Client* pClient, const Seperator* pSeperator);
void command_acceptrules(Client* pClient, const Seperator* pSeperator);
...
void command_rules(Client* pClient, const Seperator* pSeperator);
