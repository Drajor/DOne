...
{
	_log(SPELLS__REZ, "Corpse::CastRezz spellid %i, Rezzed() is %i, rezzexp is %i", spellid,isResurrected(),mResurrectionExp);
	...
	*/
	...
	worldserver.RezzPlayer(outapp, mResurrectionExp, mDBID, OP_RezzRequest);
