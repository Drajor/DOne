...
const bool XMLDataStore::setup() {
	...
	static const String createAccountSessionTableSQLITE =
		"CREATE TABLE IF NOT EXISTS _account_session (\
		id INTEGER PRIMARY KEY AUTOINCREMENT,\
...
#endif
	// Prepare query.
	static const String selectAccount = "SELECT id FROM _account WHERE ls_id = %u AND ls_account_id = %u";
...
#endif
	// Prepare query.
	static const String insertAccount = "INSERT INTO _account (status, ls_id, ls_account_id, ls_account_name, shared_platinum) VALUES(%u, %u, %u, '%s', 0)";
...
const bool XMLDataStore::accountLoad(Account* pAccount, const u32 pLSAccountID, const u32 pLSID) {
	...
	// Prepare query.
	static const auto selectAccount = "SELECT * FROM _account WHERE ls_id = %u AND ls_account_id = %u";
